...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex min-h-11 items-center justify-center rounded-2xl border border-border bg-secondary/70 p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
